...
func main() {
	...
	err, _ := devicePlugin.Serve(fpgaCpu)
	if err != nil {
		log.Println("Could not contact Kubelet, Need Support!!")
	}
	err, _ = fpgaMemPlugin.Serve(fpgaMem)
	if err != nil {
		log.Println("Could not contact Kubelet, Need Support!!")
	}
	// notice OS signal
...
restart:
	...
	err, restartTime = devicePlugin.Serve(fpgaCpu)
	err, restartTime = fpgaMemPlugin.Serve(fpgaMem)
	if err != nil {
		log.Println("Could not contact Kubelet, Need Support!!")
	}
	if !restartTime {
...
//}
//
//func ImportData(ctx *gin.Context) {
//	appG := Gin{C: ctx}
//
//	var cpu = Data{
//		ResourceName: fpgaCpu,
//		Capacity:     "1",
//		Allocated:    "0",
//	}
//	var mem = Data{
//		ResourceName: fpgaMem,
//		Capacity:     "1",
//		Allocated:    "0",
//	}
//	var data = []Data{
