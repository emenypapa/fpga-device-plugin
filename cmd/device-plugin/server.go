...
func (t *FpgaDevicePlugin) GetDevicePluginOptions(context.Context, *pluginapi.Empty) (*pluginapi.DevicePluginOptions, error) {
	return &pluginapi.DevicePluginOptions{}, nil
}

// PreStartContainer is unimplemented for this plugin， NOT BE USED
func (t *FpgaDevicePlugin) PreStartContainer(context.Context, *pluginapi.PreStartContainerRequest) (*pluginapi.PreStartContainerResponse, error) {
...
func (t *FpgaDevicePlugin) cleanup() error {
...
func (t *FpgaDevicePlugin) Stop() error {
	if t.server == nil {
		return nil
	}
	t.server.Stop()
...
func (t *FpgaDevicePlugin) Start() error {
	err := t.cleanup()
	if err != nil {
		return err
	}
...
func (t *FpgaDevicePlugin) ListAndWatch(empty *pluginapi.Empty, stream pluginapi.DevicePlugin_ListAndWatchServer) error {
...
func (t *FpgaDevicePlugin) Allocate(ctx context.Context, req *pluginapi.AllocateRequest) (*pluginapi.AllocateResponse, error) {
